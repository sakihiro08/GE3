...
void DirectXCommon::UpdateFIXFPS()
{
    ...
    std::chrono::microseconds elaspeed = std::chrono::duration_cast<std::chrono::microseconds>(now - reference);
    if (elaspeed < KMinTime)
    {
...
void DirectXCommon::InitializeDecvice()
{
    HRESULT result;
